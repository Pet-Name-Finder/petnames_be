...
liked_name1 = LikedName.create(pack_id: 1, pet_name_id: 2, liked: [true, false].sample)
liked_name2 = LikedName.create(pack_id: 1, pet_name_id: 3, liked: [true, false].sample)
...
liked_name5 = LikedName.create(pack_id: 2, pet_name_id: 7, liked: [true, false].sample)
